...
export const mockPetProducts: PetProduct[] = [
  ...
  },
  {
    ...
    review: {
      comment:
        "HeroMama益生菌晶球夾心糧－深海鱈魚口味，主原料為乾燥藍鱈及鯡魚、新鮮雞肉，並添加多株益生菌與魚油訴求亮毛護膚，本丸、麻糬、海苔都愛吃。保證分析（蛋白質43.8%、脂肪17.7%、纖維5.4%、灰分9%、水分8.5%、鈣1.21%、總磷0.88%、碳水化合物16.2%、熱量359.7kcal/100g）皆取自農業部申報網公開資料，與品牌官網數據一致。鈣磷比約1.38，在合理範圍。要注意的是配方含樹薯澱粉、豌豆蛋白，並非無穀配方，碳水化合物（DMB約17.7%）也略高於同類無穀產品。品牌官網未見第三方認證或AAFCO／FEDIAF標準的相關聲明。",
    },
    price: 980,
  ...
  },
  {
    ...
    review: {
      comment:
        "HeroMama益生菌晶球夾心糧－曠野鮮雞口味，主原料為脫水雞肉、新鮮雞肉，並添加新鮮虱目魚、小麥草、貓薄荷與多株益生菌，訴求腸胃排毛，本丸、麻糬、海苔、荳荳都愛吃。保證分析（蛋白質43.7%、脂肪17.6%、纖維5.5%、灰分9%、水分8.5%、鈣1.21%、總磷0.88%、碳水化合物16.2%、熱量359.7kcal/100g）皆取自農業部申報網公開資料，數值與同系列深海鱈魚口味幾乎相同。鈣磷比約1.38，在合理範圍。同樣要注意配方含樹薯澱粉、豌豆蛋白，並非無穀配方，碳水化合物（DMB約17.7%）偏高。品牌官網未見第三方認證或AAFCO／FEDIAF標準的相關聲明。",
    },
    price: 980,
