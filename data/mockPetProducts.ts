...
export const mockPetProducts: PetProduct[] = [
  ...
  },
  {
    ...
    review: {
      comment:
        "沙發馬鈴薯 POWER超能主食罐海陸雞魚口味，鮪魚+雞肉雙主料，DMB 碳水約 4.44%，符合 AAFCO 標準，本丸、海苔、麻糬都愛吃。鈣磷比約1.06，落在理想範圍內。",
    },
    price: 49,
  ...
  },
  {
    ...
    review: {
      comment:
        "MjAMjAM 德國魔力喵鮮肉主食罐野鹿x火雞x蔓越莓口味，成分乾淨無爭議性膠類，符合 FEDIAF 標準，三色蛋、烏克都愛吃。保證分析（含鈣磷）取自農業部申報網公開資料；官方申報未標示熱量，此處熱量（約90.5kcal/100g）依蛋白質/脂肪/碳水回推估算，非官方數字。鈣磷比約1.44，略超出理想範圍 1.0-1.4，建議留意。",
    },
    price: 160,
    affiliateUrl: "https://s.shopee.tw/111pJ4CVNr",
  },
  {
    ...
    review: {
      comment:
        "MjAMjAM 德國魔力喵鮮肉主食罐馴鹿x雞肉x胡蘿蔔口味，成分乾淨無爭議性膠類，符合 FEDIAF 標準，三色蛋、烏克都愛吃。保證分析（含鈣磷）取自農業部申報網公開資料；官方申報未標示熱量，此處熱量（約90.5kcal/100g）依蛋白質/脂肪/碳水回推估算，非官方數字。鈣磷比約1.44，略超出理想範圍 1.0-1.4，建議留意。",
    },
    price: 160,
    affiliateUrl: "https://s.shopee.tw/111pJ4CVNr",
  },
  ...
  },
  {
    ...
    relatedNews: [
      {
        title: "汪喵星球再捲污染爭議 環境部駁回訴願維持裁罰（代工廠背景新聞）",
  ...
  },
  {
    ...
    detailedAnalysis: {
      productType: "乾飼糧",
      ingredientsText:
        "乾燥雞肉、乾燥羊肉、乾燥魚肉、雞脂肪、豌豆、無調味豬肉鬆、蘋果、覆盆莓、樹薯、紅藜麥、小肽蛋白、水解酵母、乳酪粉、脫水雞肝、鮭魚油、藍莓、綠花椰菜、膳食纖維、甘露寡糖、牛磺酸、離胺酸、礦物質（鐵、鋅、銅、錳）、卵磷脂、軟骨素、蝦紅素、綜合維生素（維生素A、維生素D3、維生素C、維生素E、維生素K3、維生素B1、維生素B2、維生素B6、維生素B12、菸鹼酸、泛酸鈣、葉酸、生物素）、絲蘭、酵母硒、鱉蛋粉、益生菌、天然抗氧化劑。",
      originCountry: "台灣",
      moisture: 7.5,
      protein: 30,
      fat: 16.1,
    ...
    review: {
      comment:
        "HeroMama天然蔬果肉鬆糧－雞羊拌肉鬆餐，飼料顆粒外層包裹0調味純豬肉鬆，搭配蘋果、覆盆莓、藍莓、綠花椰菜等天然蔬果凍乾，訴求不用另外拌鮮食就香。保證分析（蛋白質30%、脂肪16.1%、纖維3.8%、灰分7.8%、水分7.5%、鈣1.2%、總磷1.0%、碳水化合物34.7%、熱量362kcal/100g）皆取自農業部申報網公開資料，與品牌官網商品資訊數值一致，數值與同系列雞魚拌肉鬆餐相近。鈣磷比約1.20，落在理想範圍內。碳水化合物偏高（DMB約37.51%），主要來自樹薯、紅藜麥與豌豆。品牌官網頁面並未提及 AAFCO、NRC 或 FEDIAF 標準相關聲明。毛孩評價待更新。",
    },
    price: 390,
  ...
  },
  {
    ...
    category: "狗狗乾糧",
    brand: "TAPAZO 特百滋",
    name: "凍乾三重奏－成犬低敏火雞配方 (2磅/907公克)",
    image: "/images/products/tapazo-freeze-dried-trio-turkey-dog.png",
    debugTags: [],
    features: ["火雞", "低敏", "無穀", "凍乾"],
    dmbCarb: 40.56,
    detailedAnalysis: {
      productType: "乾飼糧",
      ingredientsText:
        "佐餐成份：雞肉凍乾粒、鮮蛋凍乾粒、乾燥胡蘿蔔。乾糧成份：乾燥火雞肉、豌豆乾、豌豆粉、扁豆乾、雞脂（以混合生育酚保存）、火雞鮮肉、豌豆澱粉、研磨亞麻籽、甘藷乾、甜菜根乾、磷酸二鈣、天然風味劑、食鹽、鮭魚油（以混合生育酚保存）、氯化鉀、蕃茄粕乾、啤酒酵母、牛磺酸、蛋白質螯合鋅、蛋白質螯合鐵、蛋白質螯合銅、蛋白質螯合鈷、蛋白質螯合錳、碘酸鈣、亞硒酸鈉、硫酸鋅、氧化鋅、硫酸鐵、氧化錳、硫酸銅、碳酸鈷、菊苣根乾（菊糖與果寡糖來源）、氯化膽鹼、DL-甲硫氨酸、維生素E、菸鹼酸、硫胺素單硝酸鹽（維生素B1）、泛酸鈣（維生素B5）、鹽酸吡哆醇（維生素B6）、核黃素（維生素B2）、維生素A、維生素D3、生物素（維生素B7）、維生素B12、葉酸、海藻乾、菠菜乾、胡蘿蔔乾、蘋果乾、藍莓乾、蔓越莓乾、乳酸、L-色胺酸、石榴乾、綠茶抽出物、L-抗壞血酸-2-聚磷酸鹽（維生素C活性來源）、絲蘭萃取精華。",
      originCountry: "加拿大",
      moisture: 10,
      protein: 27,
      fat: 12,
    ...
    review: {
      comment:
        "TAPAZO 特百滋凍乾三重奏－成犬低敏火雞配方，乾糧本身以火雞肉為主原料，搭配豌豆、扁豆、甘藷提供澱粉來源，佐餐撒上雞肉凍乾粒、鮮蛋凍乾粒與胡蘿蔔乾燥粒。⚠️ 提醒：官方申報適用對象標示為「成犬」，並非「成幼犬」，幼犬選購前請留意。官方購物網站商品規格標示營養乾糧產地為加拿大、佐餐凍乾產地為台灣，此處產地標籤以佔比較大的乾糧產地（加拿大）為準。保證分析與熱量（4009kcal/kg）皆取自農業部申報網公開資料；官方數值為邊界保證值（水份10%以下、蛋白質27%以上等），加總約63.5%，DMB碳水以此估算約40.56%，偏高，主要來自豌豆、扁豆與甘藷。鈣磷比約1.09，落在理想範圍內。品牌官方購物網頁面商品特色明確標示「符合美國AAFCO的高營養無穀天然糧」。毛孩評價待更新。",
    },
    price: 413,
  ...
  },
  {
    ...
    category: "狗狗乾糧",
    brand: "TAPAZO 特百滋",
    name: "凍乾三重奏－成幼犬低敏羊肉配方 (2磅/907公克)",
    image: "/images/products/tapazo-freeze-dried-trio-lamb-dog.png",
    debugTags: [],
    features: ["羊肉", "低敏", "無穀", "凍乾"],
    dmbCarb: 45.56,
    detailedAnalysis: {
      productType: "乾飼糧",
      ingredientsText:
        "佐餐成份：雞肉凍乾粒、鮮蛋凍乾粒、乾燥胡蘿蔔。乾糧成份：乾燥羊肉、乾鷹嘴豆、馬鈴薯粉、乾豌豆、豌豆粉、雞脂（以混合生育酚保存）、乾燥雞肉、乾燥甜菜根、天然調味料、豌豆纖維、乾燥鮭魚、鮭魚油（以混合生育酚保存）、乾燥番茄粕、食鹽、研磨亞麻籽、乾燥雞蛋、啤酒酵母萃取物、氯化膽鹼、乾燥菊苣根（菊苣纖維與果寡糖之來源）、維生素E、維生素A、維生素D3、維生素B12、維生素C、核黃素（維生素B2）、硫胺素（維生素B1）、葉酸、生物素（維生素B7）、鹽酸吡哆醇（維生素B6）、菸鹼酸（維生素B3）、維生素K、胡蘿蔔素、泛酸鈣（維生素B5）、硫酸銅、碘酸鈣、硫酸鐵、氧化錳、氧化鋅、亞硒酸鈉、蛋白質螯合銅、蛋白質螯合鐵、蛋白質螯合鋅、蛋白質螯合錳、牛磺酸、DL-甲硫氨酸、絲蘭萃取精華、L-抗壞血酸-2-聚磷酸鹽（維生素C活性來源）、鹽酸鹽葡萄糖胺、左旋肉鹼、軟骨素、肌醇（維生素B8）、嗜酸乳桿菌、乾酪乳桿菌、比菲德氏菌、腸球菌。",
      originCountry: "加拿大",
      moisture: 10,
      protein: 26,
      fat: 10,
    ...
    review: {
      comment:
        "TAPAZO 特百滋凍乾三重奏－成幼犬低敏羊肉配方，乾糧本身以羊肉為主原料，搭配鷹嘴豆、馬鈴薯粉、豌豆提供澱粉來源，佐餐撒上雞肉凍乾粒、鮮蛋凍乾粒與胡蘿蔔乾燥粒，官方申報適用對象標示為「成幼犬」。官方購物網站商品規格標示營養乾糧產地為加拿大、佐餐凍乾產地為台灣，此處產地標籤以佔比較大的乾糧產地（加拿大）為準。保證分析與熱量（3935kcal/kg）皆取自農業部申報網公開資料；官方數值為邊界保證值（水份10%以下、蛋白質26%以上等），加總約59%，DMB碳水以此估算約45.56%，明顯偏高，主要來自鷹嘴豆與馬鈴薯粉。鈣磷比約1.19，落在理想範圍內。品牌官方購物網頁面商品特色明確標示「符合美國AAFCO的高營養無穀天然糧」。毛孩評價待更新。",
    },
    price: 413,
    affiliateUrl: "https://s.shopee.tw/2qTYDUDjUm",
  },
  ...
  },
  {
    ...
    review: {
      comment:
        "ParkCat 無敵貓糧鮮雞蜂王乳口味，蛋白質 42% 偏高，本丸、海苔、麻糬都愛吃，符合 AAFCO 標準。磷含量約224mg/100kcal、鈣磷比約1.88:1，鈣磷比略超出理想範圍 1.0-1.4。",
    },
    price: 280,
  ...
  },
  {
    ...
    review: {
      comment:
        "ParkCat 無敵貓糧大洋鮮極魚口味，多種魚肉來源、蛋白質 42% 偏高，本丸、海苔、麻糬都愛吃，符合 AAFCO 標準。磷含量約258mg/100kcal、鈣磷比約1.56:1，鈣磷比略超出理想範圍 1.0-1.4。",
    },
    price: 340,
  ...
  },
  {
    ...
    review: {
      comment:
        "TAPAZO 特百滋貓用凍乾填心糧成幼貓低敏鮮雞配方，符合 AAFCO 標準，志龍、豆豆龍、烏龍都愛吃。保證分析與熱量（代謝能3640kcal/kg）皆取自農業部申報網公開資料。鈣磷比約1.8，超出理想範圍 1.0-1.4，建議留意。",
    },
    price: 360,
  ...
  },
  {
    ...
    review: {
      comment:
        "Mobby莫比自然食無穀配方鹿肉x鮭魚，本丸、麻糬、海苔都愛吃。這款原料確實無穀（豌豆、甜薯、馬鈴薯蛋白質為主），符合無穀標示。保證分析（蛋白質43%、脂肪18%、灰分8%、纖維2%、鈣1.5%、磷1%）取自農業部申報網公開資料；官方未列出熱量，此處熱量（374.5kcal/100g，即3745kcal/kg）取自品牌授權經銷網站標示的營養標示表格，非官方申報數字，多家經銷網站數字一致，並標示產地為美國。鈣磷比約1.5，略高於理想範圍 1.0-1.4，建議留意。AAFCO標示依品牌官方文案與多家經銷網站說明認定，官方申報本身未附此項聲明。",
    },
    price: 489,
    affiliateUrl: "https://s.shopee.tw/qiQXqUFwA",
  },
  ...
  },
  {
    ...
    detailedAnalysis: {
      productType: "罐頭",
      ingredientsText:
        "水、雞肉、葵花籽油、樹薯澱粉、羊奶粉、營養胺基酸、魚油、益源質、蔓越莓提取物、牛磺酸、綜合礦物質、維生素（E、B群、A、D3）。",
      originCountry: "泰國",
      moisture: 81,
      protein: 11,
      fat: 5.2,
    ...
    review: {
      comment:
        "HeroMama貓用無膠迷你主食罐－雞肉奶糕肉泥口味，55g小罐一次吃完不浪費，質地綿密適合乾糧貓轉換或挑嘴貓，本丸、麻糬、海苔都超愛。保證分析（蛋白質11%、脂肪5.2%、纖維0.3%、灰分1.3%、水分81%、碳水化合物1.5%、鈣0.19%、總磷0.15%、代謝能87.95kcal/100g）皆取自農業部申報網公開資料。鈣磷比約1.27，落在理想範圍內。品牌官網明確標示「依據國際主食AAFCO營養標準設計」，且原料無穀、無添加膠類。產地為泰國生產（台灣團隊研發、監製），與同品牌乾糧系列的台灣代工廠不同；申報資料顯示檢驗仍由所屬牧羊人集團的希格瑪工廠負責。",
    },
    price: 33,
  ...
  },
  {
    ...
    category: "貓咪主食罐",
    brand: "T.N.A. 悠遊 厚肉肉",
    name: "厚肉肉主食罐－海味旗魚拼海瓜子 (80g)",
    image: "/images/products/hoorooroo-swordfish-clam-cat-can.jpg",
    debugTags: ["無膠"],
    features: ["旗魚", "海瓜子", "無穀", "成貓"],
    dmbCarb: 3.62,
    detailedAnalysis: {
      productType: "罐頭",
      ingredientsText:
        "旗魚、熬煮魚湯、海瓜子、雞肝、雞油、蛋黃粉、雞心、滴雞精、綜合維生素、海藻鈣、紅蘿蔔、柴魚粉、洋車前子、綜合胺基酸、酵母粉、蒟蒻粉、牛磺酸、β-聚葡萄糖。",
      originCountry: "台灣",
      moisture: 77.9,
      protein: 14.0,
      fat: 5.5,
    ...
    review: {
      comment:
        "T.N.A.悠遊厚肉肉主食罐海味旗魚拼海瓜子口味，前二項食材為旗魚與熬煮魚湯，官方訴求98%高含肉量、無穀無膠無防腐劑無K3，並添加滴雞精與β-聚葡萄糖。保證分析與熱量皆取自農業部申報網公開資料（官方登記規格為0.08kg，與本品80g規格相符）；製造工廠為興濠有限公司（台灣）。官方品牌網站tnayoyochic.com明確標示「符合AAFCO，全齡貓安心食用」。⚠️ 需留意：農業部申報網登記鈣為0.26%（鈣磷比約1.63，略超出理想範圍），但授權經銷商網站複製包裝標示的鈣為0.22%（鈣磷比1.38，落在理想範圍內，且與其磷含量、熱量數字內部自洽），兩者有落差，此處採信官方申報網數字計分，實際包裝數值請以到貨實品標示為準。毛孩評價待更新。",
    },
    price: 46,
  ...
  },
  {
    ...
    review: {
      comment:
        "毛孩時代80%鮮魚肉無穀全貓糧，主原料為脫水魚肉（鰹魚、鯡魚、鱈魚、鰈魚、沙丁魚），原料確實無穀（豌豆、番薯為主）。保證分析（蛋白質37%、脂肪18%、纖維5%、灰分10%、鈣1%、總磷0.84%、碳水化合物20%、熱量352.5kcal/100g）皆取自農業部申報網公開資料，資料完整度高，官方連碳水與熱量都有直接標示。鈣磷比約1.19，落在理想範圍內。品牌標示符合 AAFCO、FEDIAF 標準（此聲明未見於農業部申報網摘要，依廠商包裝／官方文案認定）。委託代工廠「台灣信元寵物食品股份有限公司」（信元製藥集團）官方認證頁面列出中科廠、虎躍廠皆具備 HACCP、ISO22000 認證。毛孩評價待更新。",
    },
    price: 850,
  ...
  },
  {
    ...
    review: {
      comment:
        "毛孩時代85%鮮雞肉無穀全貓糧，主原料為脫水雞肉（台灣、澳洲）與新鮮雞肉漿（台灣氣冷雞），原料確實無穀（豌豆、番薯為主），烏克愛吃。保證分析（蛋白質48%、脂肪17%、纖維5%、灰分10%、水分8%、鈣1%、總磷0.84%、碳水化合物12%、熱量354.5kcal/100g）皆取自農業部申報網公開資料，官方連碳水與熱量都有直接標示。鈣磷比約1.19，落在理想範圍內。品牌官網明確標示營養成分符合 AAFCO、FEDIAF 兩大標準。委託代工廠「台灣信元寵物食品股份有限公司」（信元製藥集團）官方認證頁面列出中科廠、虎躍廠皆具備 HACCP、ISO22000 認證。",
    },
    price: 790,
  ...
  },
  {
    ...
    category: "貓咪乾糧",
    brand: "毛孩時代",
    name: "7+熟齡貓鮮雞肉低磷關節貓糧 (關節保健/老貓飼料/貓乾糧/無穀貓糧) (1.5kg)",
    image: "/images/products/maohaishidai-chicken-senior-joint.png",
    debugTags: [],
    features: ["雞肉", "無穀", "熟齡貓", "關節保健", "低磷"],
    dmbCarb: 27.17,
    detailedAnalysis: {
      productType: "乾飼糧",
      ingredientsText:
        "脫水雞肉（台灣、澳洲）、豌豆、水解蛋白、酵母、新鮮雞肉漿（台灣氣冷雞）、番薯、雞油、魚油（鮭魚油、SPD專利魚油，含omega-3）、甜菜、苜蓿、纖維素、洋車前子、絲蘭、N-乙醯基-D-葡萄糖胺、硫酸軟骨素、蘑菇萃取物、菊糖、果寡糖、左旋肉鹼、牛磺酸、甲硫胺酸、碳酸鈣、氯化鉀、檸檬酸鉀、有機鋅、有機鐵、有機錳、有機銅、有機硒、有機鉻、維生素A、維生素D3、維生素E、維生素B1、維生素B2、維生素B6、維生素B12、菸鹼酸、泛酸、葉酸、氯化膽鹼。",
      originCountry: "台灣",
      moisture: 8,
      protein: 37,
      fat: 17,
    ...
    review: {
      comment:
        "毛孩時代7+熟齡貓鮮雞肉低磷關節貓糧，主原料為脫水雞肉（台灣、澳洲）與新鮮雞肉漿（台灣氣冷雞），原料確實無穀（豌豆、番薯為主），額外添加洋車前子、N-乙醯基-D-葡萄糖胺、硫酸軟骨素等關節保健成分，訴求7歲以上熟齡貓專用。保證分析（蛋白質37%、脂肪17%、纖維5%、灰分8%、水分8%、鈣0.9%、總磷0.79%、碳水化合物25%、熱量361.5kcal/100g）皆取自農業部申報網公開資料，與品牌官網熱量數值一致。鈣磷比約1.14，落在理想範圍內；磷含量刻意降低，符合熟齡貓腎臟保健訴求。品牌官網明確標示營養成分符合 AAFCO、FEDIAF 兩大標準。委託代工廠「台灣信元寵物食品股份有限公司」（信元製藥集團）官方認證頁面列出中科廠、虎躍廠皆具備 HACCP、ISO22000 認證。毛孩評價待更新。",
    },
    price: 850,
    affiliateUrl: "https://s.shopee.tw/9fJqtVV0h4",
  },
  {
    id: "cat-dry-025",
    category: "貓咪乾糧",
    brand: "毛孩時代",
    name: "7+熟齡貓鮮魚肉低磷關節貓糧 (關節保健/老貓飼料/貓乾糧/無穀貓糧) (1.5kg)",
    image: "/images/products/maohaishidai-fish-senior-joint.png",
    debugTags: [],
    features: ["魚肉", "無穀", "熟齡貓", "關節保健", "低磷"],
    dmbCarb: 27.17,
    detailedAnalysis: {
      productType: "乾飼糧",
      ingredientsText:
        "脫水魚肉（鱈魚）、酵母、豌豆、水解蛋白、雞油、番薯、新鮮鮭魚泥、魚油（鮭魚油、SPD專利魚油，含omega-3）、纖維素、洋車前子、絲蘭、N-乙醯基-D-葡萄糖胺、硫酸軟骨素、蘑菇萃取物、鱉蛋、菊糖、果寡糖、左旋肉鹼、牛磺酸、甲硫胺酸、碳酸鈣、氯化鉀、檸檬酸鉀、有機鋅、有機鐵、有機錳、有機銅、有機硒、有機鉻、維生素A、維生素D3、維生素E、維生素B1、維生素B2、維生素B6、維生素B12、菸鹼酸、泛酸、葉酸、氯化膽鹼。",
      originCountry: "台灣",
      moisture: 8,
      protein: 37,
      fat: 17,
    ...
    review: {
      comment:
        "毛孩時代7+熟齡貓鮮魚肉低磷關節貓糧，主原料為脫水魚肉（鱈魚）與新鮮鮭魚泥，原料確實無穀（豌豆、番薯為主），額外添加洋車前子、N-乙醯基-D-葡萄糖胺、硫酸軟骨素等關節保健成分，訴求7歲以上熟齡貓專用。保證分析（蛋白質37%、脂肪17%、纖維5%、灰分8%、水分8%、鈣0.9%、總磷0.81%、碳水化合物25%、熱量361.5kcal/100g）皆取自農業部申報網公開資料，與品牌官網熱量數值一致，數值與同系列鮮雞肉版本幾乎相同。鈣磷比約1.11，落在理想範圍內；磷含量刻意降低，符合熟齡貓腎臟保健訴求。品牌官網明確標示營養成分符合 AAFCO、FEDIAF 兩大標準。委託代工廠「台灣信元寵物食品股份有限公司」（信元製藥集團）官方認證頁面列出中科廠、虎躍廠皆具備 HACCP、ISO22000 認證。毛孩評價待更新。",
    },
    price: 890,
    affiliateUrl: "https://s.shopee.tw/3g2dlJUvCT",
  },
  {
    id: "cat-dry-021",
    category: "貓咪乾糧",
    ...
    review: {
      comment:
        "HeroMama益生菌晶球夾心糧－深海鱈魚口味，主原料為乾燥藍鱈及鯡魚、新鮮雞肉，並添加多株益生菌與魚油訴求亮毛護膚，本丸、麻糬、海苔都愛吃。保證分析（蛋白質43.8%、脂肪17.7%、纖維5.4%、灰分9%、水分8.5%、鈣1.21%、總磷0.88%、碳水化合物16.2%、熱量359.7kcal/100g）皆取自農業部申報網公開資料，與品牌官網數據一致。⚠️ 更正：先前查核未展開品牌官網「夾心糧Q&A」收合區塊，該處明確標示「夾心糧的營養配分依據AAFCO / NRC每日營養標準」，已補上 AAFCO／NRC 認證標示。鈣磷比約1.38，在合理範圍。要注意的是配方含樹薯澱粉、豌豆蛋白，並非無穀配方，碳水化合物（DMB約17.7%）也略高於同類無穀產品。",
    },
    price: 980,
  ...
  },
  {
    ...
    review: {
      comment:
        "HeroMama益生菌晶球夾心糧－曠野鮮雞口味，主原料為脫水雞肉、新鮮雞肉，並添加新鮮虱目魚、小麥草、貓薄荷與多株益生菌，訴求腸胃排毛，本丸、麻糬、海苔、荳荳都愛吃。保證分析（蛋白質43.7%、脂肪17.6%、纖維5.5%、灰分9%、水分8.5%、鈣1.21%、總磷0.88%、碳水化合物16.2%、熱量359.7kcal/100g）皆取自農業部申報網公開資料，數值與同系列深海鱈魚口味幾乎相同。⚠️ 更正：先前查核未展開品牌官網「夾心糧Q&A」收合區塊，該處明確標示「夾心糧的營養配分依據AAFCO / NRC每日營養標準」，已補上 AAFCO／NRC 認證標示。鈣磷比約1.38，在合理範圍。同樣要注意配方含樹薯澱粉、豌豆蛋白，並非無穀配方，碳水化合物（DMB約17.7%）偏高。",
    },
    price: 980,
  ...
  },
  {
    ...
    category: "貓咪乾糧",
    brand: "nu4PET 陪心寵糧",
    name: "Pawful陪飽糧 低穀貓糧 雞肉口味 (2磅)",
    image: "/images/products/nu4pet-pawful-chicken-cat.jpg",
    debugTags: [],
    features: ["雞肉", "含穀", "成貓"],
    dmbCarb: 30.0,
    detailedAnalysis: {
      productType: "乾飼糧",
      ingredientsText:
        "雞肉、燕麥、冷壓椰子粉、鮭魚油、水解蛋白、酵母粉、氯化膽鹼、黃金亞麻籽、甜菜、苜蓿、絲蘭萃取物、蘋果、紫地瓜、番茄、胡蘿蔔、綠茶、蜂王乳、蔓越莓、藍莓、覆盆莓、巴西莓、西印度櫻桃、綜合維生素(A、D、E、B1、B2、B6、B12、葉酸、泛酸鈣、菸鹼酸、生物素)、綜合礦物質(硫酸鋅、硫酸銅、硫酸錳、硫酸亞鐵、酵母硒、碳酸鈷、碘化鉀)、DL-蛋胺酸、牛磺酸、L-離胺酸。",
      originCountry: "澳洲",
      moisture: 10,
      protein: 37,
      fat: 11,
    ...
    review: {
      comment:
        "nu4PET陪心寵糧全新副牌Pawful陪飽糧低穀貓糧雞肉口味，前二項食材為雞肉、燕麥，官方訴求96%動物性蛋白來源，添加鮭魚油、亞麻籽顧毛髮，蔓越莓、藍莓顧泌尿道，含燕麥非無穀配方。保證分析、成分與熱量（3175kcal/kg）皆取自農業部申報網公開資料（官方登記規格為2Ibs/0.91kg，與本品規格相符），官方申報產地為輸入，經比對官方商品包裝圖確認印有「Made in Australia」澳洲原產標示。包裝下方印有「營養規格符合 AAFCO 和 NRC 標準」字樣（經實品包裝照片確認），故標示 AAFCO／NRC 認證。鈣磷比官方標示為鈣最低1.0%、磷最低0.8%，換算後鈣磷比約1.25:1，落在理想範圍內。毛孩評價待更新。",
    },
    price: 359,
    affiliateUrl: "https://s.shopee.tw/6L3UI9Xiof",
  },
  {
    id: "cat-dry-031",
    category: "貓咪乾糧",
    brand: "nu4PET 陪心寵糧",
    name: "Pawful陪飽糧 低穀貓糧 魚肉口味 (2磅)",
    image: "/images/products/nu4pet-pawful-tuna-cat.jpg",
    debugTags: [],
    features: ["鮪魚", "含穀", "成貓"],
    dmbCarb: 30.56,
    detailedAnalysis: {
      productType: "乾飼糧",
      ingredientsText:
        "鮪魚、燕麥、冷壓椰子粉、鮭魚油、水解蛋白、酵母粉、氯化膽鹼、黃金亞麻籽、甜菜、苜蓿、絲蘭萃取物、蘋果、紫地瓜、番茄、胡蘿蔔、綠茶、野莓、蔓越莓、藍莓、覆盆莓、西印度櫻桃、綜合維生素(A、D、E、B1、B2、B6、B12、葉酸、泛酸鈣、菸鹼酸、生物素)、綜合礦物質(硫酸鋅、硫酸銅、硫酸錳、硫酸亞鐵、酵母硒、碳酸鈷、碘化鉀)、DL-蛋胺酸、牛磺酸、L-離胺酸。",
      originCountry: "澳洲",
      moisture: 10,
      protein: 36.5,
      fat: 11,
    ...
    review: {
      comment:
        "nu4PET陪心寵糧全新副牌Pawful陪飽糧低穀貓糧魚肉口味，前二項食材為鮪魚、燕麥，官方訴求96%動物性蛋白來源，添加鮭魚油、亞麻籽顧毛髮，蔓越莓、藍莓顧泌尿道，含燕麥非無穀配方。保證分析、成分與熱量（3175kcal/kg）皆取自農業部申報網公開資料（官方登記規格為2Ibs/0.91kg，與本品規格相符），官方申報產地為輸入；產地標示比照同系列雞肉口味款的澳洲包裝標示，待本款包裝實品照片進一步確認。AAFCO標示依使用者確認之包裝資訊認定，NRC標示待包裝照片確認後補上。鈣磷比官方標示皆為最低1.0%，換算後鈣磷比約1.0:1，落在理想範圍內。毛孩評價待更新。",
    },
    price: 359,
    affiliateUrl: "https://s.shopee.tw/6L3UI9Xiof",
  },
