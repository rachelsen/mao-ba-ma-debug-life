...
export const mockPetProducts: PetProduct[] = [
  ...
  },
  {
    ...
    category: "貓咪乾糧",
    brand: "Hill's 希爾思",
    name: "完美體重 雞肉 1-6歲成貓 (1.36公斤+罐頭6入組合)",
    image: "/images/products/hills-perfect-weight-chicken-adult-cat.png",
    debugTags: [],
    features: ["體重控制", "減重配方", "雞肉", "組合包"],
    partialNutrition: {
      items: [
        { label: "粗蛋白質(min)", value: "35.5%" },
        { label: "粗脂肪(min)", value: "9%" },
      ...
      note: "以上為乾糧本體的官方保證成分分析（未列出灰分、磷、熱量，纖維僅提供範圍），組合內附贈的罐頭保證分析未提供，故無法提供完整乾物比／熱量佔對照表。",
    },
    aafcoCertified: true,
    ourCatsRating: [
      { cat: "本丸", verdict: "like" },
    ...
    review: {
      comment:
        "希爾思完美體重雞肉配方 1.36 公斤＋罐頭 6 入組合包，專為 1-6 歲成貓體重控制設計，符合 AAFCO 標準，本丸、海苔、麻糬都愛吃。",
    },
    price: 1357,
    affiliateUrl: "https://s.shopee.tw/3Vj2uUQww5",
  },
